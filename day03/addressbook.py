...
import contact
import os # 운영체제에서 사용할 기능을 가지고 있는 모듈
...
def load_contact(lst_contact):
    ...
    while True:
        line = f.readline() #현수/1234/naver.com/김천
        if not line:
...
if __name__ == '__main__':
    ...
    #print('주소록 프로그램')
    # 3. 클래스 실행
    # first = contact.Contact('현수', '010-8245-2221', 'hyunsoo1702@naver.com', '김천')
    # print(first)
    run() # 제일 처음 실행되는 함수
